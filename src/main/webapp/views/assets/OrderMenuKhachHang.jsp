							...
							<c:forEach items="${listmenu }" var="menu">
								<div class="body_item l-2-4">
									...
									<div class="item_quantity">
										<input style="width: 80px; margin: 5px 0;" type="number"
											name="soluong" id="" value="1">
									</div>
									<div class="item_order">
                                	 ...
                                	 --%>
										<button type="submit"
											formaction="/QL_Dat_Ban_NH/Order/chonmon?idmn=${menu.idmn}"
											class="btn btn-success">CHỌN MÓN</button>
							...
							<table class="table">
									...
									<c:forEach items="${gh }" var="giohang">
										<tr>
											<th><img
												...
												src="${giohang.menu.img }" alt=""></th>
											<td>${giohang.menu.ten_Mon_An }</td>
											<td>${giohang.menu.loaiMenu.tenLoai }</td>
											<td><input type="text" style="width: 100px;" readonly
												name="" id="" value="${giohang.so_luong }"></td>
											<td>${giohang.menu.gia*giohang.so_luong}</td>
											<td>

												<button
													formaction="/QL_Dat_Ban_NH/Order/delete?id=${giohang.idgh}"
								...
								<tfoot>
									<tr>
										...
										<td></td>
										<td></td>
										<td><button formaction="/QL_Dat_Ban_NH/Order/datban"
												style="float: right;" class="btn btn-success btn-block">
												GỌI MÓN <i class="fa fa-angle-right"></i>
											</button></td>
									</tr>
								</tfoot>
							</table>
