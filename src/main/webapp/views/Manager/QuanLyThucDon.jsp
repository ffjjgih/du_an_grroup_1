							...
							<c:forEach var="items" items="${listmenu }">
								<div class="content_item">
									...
									<div class="item_button">
										<button type="submit" class="btn btn-success" formaction="/QL_Dat_Ban_NH/ThemMenuManager/edit?id=${items.idmn }">
		...
		<div class="modal_add js_modal_add">
			<div class="modal_add_container js_modal_add_container">
				...
				<form action="/QL_Dat_Ban_NH/ThemMenuManager" method="post"
					...
					<select class="form-select" name="trangthai" style="margin-bottom: 30px;" aria-label="Default select example">
