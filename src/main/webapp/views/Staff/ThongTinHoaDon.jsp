...
<body>
                        ...
                        <div class="body_right_content">
                            <div class="content_thanhtoan">
                                ...
                                <div class="container_body">
                                    <div class="mb-3 row">
                                        <label for="staticEmail" class="col-sm-2 col-form-label" style="font-weight: 500;">Mã bàn:</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="mb-3 row">
                                        <label for="inputPassword" class="col-sm-2 col-form-label" style="font-weight: 500;">Số hóa đơn:</label>
                                        <div class="col-sm-10">
                                            <input type="text" readonly class="form-control-plaintext" id="staticEmail"
                                                value="1">
                                        </div>
                                    ...
                                    <div class="mb-3 row">
                                        <label for="staticEmail" class="col-sm-2 col-form-label" style="font-weight: 500;">Khách hàng:</label>
                                        <div class="col-sm-10">
                                            <input type="text" readonly class="form-control-plaintext" id="staticEmail"
                                                value="Nguyễn Lê Hải">
                                        </div>
                                    ...
                                    <div class="mb-3 row">
                                        <label for="inputPassword" class="col-sm-2 col-form-label" style="font-weight: 500;">Giờ vào:</label>
                                        <div class="col-sm-10">
                                            <input type="text" readonly class="form-control-plaintext" id="staticEmail"
                                                value="17:05 PM">
                                        </div>
                                    ...
                                    <div class="mb-3 row">
                                        <label for="staticEmail" class="col-sm-2 col-form-label" style="font-weight: 500;">Giờ ra:</label>
                                        <div class="col-sm-10">
                                            <input type="text" readonly class="form-control-plaintext" id="staticEmail"
                                                value="19:00 PM">
                                        </div>
                                    ...
                                    <div class="mb-3 row">
                                        <label for="staticEmail" class="col-sm-2 col-form-label">Số tiền phải thu</label>
                                        <div class="col-sm-10">
                                            <input readonly type="text" class="form-control" id="tienthu" value="400.000">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <label for="inputPassword" class="col-sm-2 col-form-label">Voucher</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="voucher" value="">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <label for="staticEmail" class="col-sm-2 col-form-label">Số tiền khách đưa</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" onkeyup="calculate()" id="khachdua" value="">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <label for="inputPassword" class="col-sm-2 col-form-label">Số tiền thừa</label>
                                        <div class="col-sm-10">
                                            <input readonly type="text" class="form-control" id="tienthua" value="">
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        function calculate(){
            ...
            var result = 0.0;
            if (voucher > 0) {
                result = parseFloat(tienthu) - (parseFloat(tienhoadon) * (voucher / 100));
            } else {
