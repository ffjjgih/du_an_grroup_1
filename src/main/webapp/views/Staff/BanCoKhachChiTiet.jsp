                    ...
                    <div class="body_right l-9">
                        <form action="" method="post">
                            <div class="mb-3">
                                ...
                                <input readonly type="text" class="form-control" id="exampleFormControlID" value="03">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input readonly type="text" class="form-control" id="exampleFormControlDate" value="2014-02-09">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlDate" class="form-label">Giờ đặt</label>
                                <input readonly type="text" class="form-control" id="exampleFormControlDate" value="14:00 PM">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlTime" class="form-label">Giờ vào</label>
                                <input readonly type="text" class="form-control" id="exampleFormControlTime" value="15:00 PM">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlQuan" class="form-label">Số lượng người</label>
                                <input readonly type="text" class="form-control" id="exampleFormControlQuan" value="10">
                            </div>
                            <div class="mb-3">
